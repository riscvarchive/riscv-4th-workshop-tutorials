...
class TerminalFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(ID_UL_BLOB, "&Upload blob...", "", wx.ITEM_NORMAL)
        self.frame_terminal_menubar.Append(wxglade_tmp_menu, "&Tools")
        ...
        self.Bind(wx.EVT_MENU, self.OnUploadBlob, id=ID_UL_BLOB)
        # end wxGlade
